...
> **[choTaku](https://github.com/AvaTar-ArTs/choTaku) — a provider-neutral storyworld compiler for canon, characters, lore, narrative graphs, visual layouts, provenance, and multimodal artifacts.**

Use [Origin Story](https://github.com/AvaTar-ArTs/origin-story) as the companion research, repository-archaeology, and comprehension layer.
...
- [Future trends priority roadmap](docs/future-trends-priority.md)
- [Research, sources, and reasoning ledger](docs/research-and-source-ledger.md)
...
- [choTaku](https://github.com/AvaTar-ArTs/choTaku) — executable storyworld and artifact compiler
- [Origin Story](https://github.com/AvaTar-ArTs/origin-story) — repository archaeology and creative-systems comprehension
- [AvatarArts Comic Creator Matrix](https://github.com/AvaTar-ArTs/AvatarArts-Comic-Creator-Matrix) — production capability map
- [agent-skills](https://github.com/AvaTar-ArTs/agent-skills) — skills and agent resources
- [my-mcp-creator](https://github.com/AvaTar-ArTs/my-mcp-creator) — bounded MCP experimentation
